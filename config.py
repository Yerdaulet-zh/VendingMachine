...
cell_positions_path = "cell_positions.json"

with open(products_path, 'r') as j_file:
    products = json.load(j_file)

with open(products_path, 'r') as j_file:
    original = json.load(j_file)

with open(cell_positions_path, 'r') as j_file:
